...
impl TargetData {
    ...
    ///
    // ponytail: returned as a `serde_json::Value`, not a typed tree. The command
    // validator (ADR-0012, ROADMAP Phase 1) is what defines the shape it needs;
    // model it then, against a real consumer, not now.
